...
class Field(object):
    ...
    def __init__(self, **kw):
        ...
        self.renewable = kw.get('renewable', True)
...
class Model(dict):
    ...
    def __getattr__(self, item):
        try:
            ...
            raise AttributeError(r"'Dict' object has not attribute '%s'" % item)
...
if __name__ == '__main__':
    ...
    Database.create_engine('root', '', 'test')
    Database.update('drop table if exists user')
    Database.update('create table user '
